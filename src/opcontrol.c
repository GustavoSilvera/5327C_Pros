...
void operatorControl(){//initializes everythin
	...
	FourBarPID->kP = 0.075;//pretty efficient lift tho
	...
	LiftPID->motor2 = 0;
	LiftPID->thresh = 20;
	LiftPID->kP = 0.2;//lol lift is not vry efficient
	LiftPID->slew = false;
	LiftPID->reversed = false;
	LiftPID->isRunning = false;
	LiftPID->Mopposite = true;//if motors controlled by the lift should go different directions
